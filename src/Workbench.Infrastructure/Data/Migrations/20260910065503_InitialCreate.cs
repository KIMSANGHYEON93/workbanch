        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    LastIssueNumber = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Attachments_SingleOwner", "(CASE WHEN [IssueId] IS NULL THEN 0 ELSE 1 END + CASE WHEN [PageId] IS NULL THEN 0 ELSE 1 END) = 1");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Comments_SingleOwner", "(CASE WHEN [IssueId] IS NULL THEN 0 ELSE 1 END + CASE WHEN [PageId] IS NULL THEN 0 ELSE 1 END) = 1");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_PageId_CreatedAt",
                table: "Comments",
